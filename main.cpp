/*
 *  Some debugging statements are commented out after use.
 *  The program breaks after running,
 *  but after repeated debugging I think this may not affect the results.
 *  
 *
 */
#include <map>
